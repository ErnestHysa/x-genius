...
export const PrivacyPolicy: React.FC = () => {
  return (
    <div className="prose prose-invert max-w-none p-6 text-slate-300">
      ...
      <ul>
        <li>
          <strong>Authentication Information:</strong> When you log in using X (formerly Twitter) via Supabase, we receive your public profile information, such as your username, display name, and avatar URL. We also receive an authentication token from Supabase which is used to verify your identity when you post content.
        </li>
        <li>
        ...
        <li>
          <strong>Generated Content:</strong> The content you generate using the application is held temporarily in the application's state and is sent to our Supabase Edge Function only when you choose to post it. We do not store this content after it has been posted.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Authentication Tokens:</strong> Authentication is managed by Supabase. Tokens are handled securely according to industry best practices.</li>
      </ul>
      ...
      <ul>
        <li>
            <strong>Supabase:</strong> Used for authentication with X and for hosting the serverless function that posts your content. We recommend reviewing Supabase's privacy policy.
        </li>
        <li>
